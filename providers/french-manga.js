...
function fetchOnce(url, options, opts, timeoutMs) {
  ...
  // REAL timeout via Promise.race (Nuvio ignores AbortController). If the fetch hangs, the timer
  // wins -> null -> the provider moves on instead of freezing the whole run.
