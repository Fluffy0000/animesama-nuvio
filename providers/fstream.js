/* fstream - built 2026-08-26T17:09:47Z — GENERATED from src/, edit sources then `python3 build.py` */
// ---- core/net.js ----
...
function tvEntries(episodes, episode, seen) {
  var out = [];
  if (!episodes) return sortAndFilterStreams(out);
  var ep = episodes[String(episode)] || episodes[episode] || null;
  if (!ep || !ep.languages) return sortAndFilterStreams(out);
